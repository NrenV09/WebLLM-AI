...
import { X, Sliders, RotateCcw, Check, Sparkles, Code, Brain, Lightbulb } from 'lucide-react';
      ...
      <div className="w-full max-w-xl bg-[#12141a]/95 border border-white/[0.08] rounded-3xl shadow-2xl backdrop-blur-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-white/[0.06] flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-medium text-white">Generation Parameters</h2>
              <p className="text-xs text-white/50">Configure local model sampling and system instructions</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4 bg-[#0e1015]/80 border-t border-white/[0.06] flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white text-xs font-semibold shadow-lg shadow-blue-500/20 transition-all cursor-pointer active:scale-95"
            >
